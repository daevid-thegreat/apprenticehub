...
const Offer = () => {
  return (
    <div className="flex-col justify-items-center px-28">
      ...
      <div className="skills">
        <div className="font-Lexend text-primary font-bold text-4xl leading-normal ml-24 pt-20">Connecting Great Skills<br/>TO Great People</div>
