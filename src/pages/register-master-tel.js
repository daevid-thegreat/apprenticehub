      ...
      <div className='font-Poppins'>
        ...
        <div className='flex items-center justify-center'>
          <form className='w-1/2'>
            ...
            <div>
              <div className="mb-6">
                ...
                <div className='flex items-center w-full bg-[#F7F7F7] rounded-lg'>
                    <span className='font-medium text-gray'>+234 </span>
                    <input
                ...
                <p className='text-sm font-semibold text-primary text-end my-2 cursor-pointer'><Link href='/register-apprentice'>Use Email Instead</Link></p>
              </div>
            ...
            <div className='my-4'>
              <p className='text-center my-3 text-gray'>Not an apprentice? <Link className='text-[#EF5D5D] font-semibold' href='/register-apprentice'>Sign Up as an Apprentice</Link></p>
            </div>
...
export default register_apprentice_tel