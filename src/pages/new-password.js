...
const register_apprentice = () => {
    ...
    const submitHandler = async (e) => {
        ...
        const res = await fetch('https://apprenticehubapi.onrender.com/auth/new-password/', {
            method: 'POST',
            headers: {
        ...
        <div className='grid grid-cols-2 md:grid-cols-1'>
            ...
            <div className='font-Poppins'>
                <div className='text-center mt-8 mb-14'>
                    ...
                    <h2 className='text-4xl font-bold my-3'>Set new password </h2>
                ...
                <div className='flex items-center justify-center'>
                    <form className='w-1/2 md:w-full md:mx-6' onSubmit={submitHandler}>
                        ...
                        <div className="mb-6">
                            ...
                            <p className='text-sm font-semibold text-primary text-end my-2 cursor-pointer'>Resend OTP</p>
                        </div>
                        ...
                        <div className='my-4'>
                            <p className='text-center my-3 text-gray'>Remembered Password? <Link className='text-[#EF5D5D] font-semibold' href='/login-apprentice'>Sign In</Link></p>
                        </div>
